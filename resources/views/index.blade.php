                ...
                <div class="card-body">
                    <div class="table-responsive browser_users">
                        <table class="table mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td><a href="#" class="text-primary">Ram Nagar Tehsil </a></td>
                                    <td>FRP Components
                                    </td>
                                ...
                                <!--end tr-->
                                <tr>
                                    <td><a href="#" class="text-primary"> Barhi Industrial Estate, </a></td>
                                    <td> APC Components
                                ...
                                <!--end tr-->
                                <tr>
                                    <td><a href="#" class="text-primary">Matiyala Store </a></td>
                                ...
                                <!--end tr-->
                                <tr>
                                    <td><a href="#" class="text-primary">Dhaturi, Sonipat </a></td>
