...
<div class="container-fluid">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="text-center">
                        ...
                        <div class="">
                            <h5 class="mb-0 fw-bold">Pragati Pandey</h5>
                        ...
                        <p class="text-muted px-3 fw-semibold">I see obstacles as opportunities, find solutions in
                ...
                <div class="card-body">
                    <div class="media align-items-center mb-3">
                        ...
                        <div class="media-body ms-3 align-self-center">
                            <h6 class="m-0 font-15">Overall Progress </h6>
                    ...
                    <div class="media align-items-center mb-3">
                        ...
                        <div class="media-body ms-3 align-self-center">
                            <h6 class="m-0 font-15"> Completed</h6>
                            <div class="d-flex justify-content-between">
                                <span>
                                    <a class="" href="#">
                                        <i class="mdi mdi-format-list-bulleted text-success"></i>
                    ...
                    <div class="media align-items-center mb-3">
                        ...
                        <div class="media-body ms-3 align-self-center">
                            <h6 class="m-0 font-15"> In-progress</h6>
                            <div class="d-flex justify-content-between">
                                <span>
                                    <a class="" href="#">
                                        <i class="mdi mdi-format-list-bulleted text-success"></i>
                    ...
                    <div class="media align-items-center">
                        ...
                        <div class="media-body ms-3 align-self-center">
                            <h6 class="m-0 font-15">Anticipated</h6>
                                    <div class="d-flex justify-content-between">
                                        <span>
                                            <a class="" href="#">
                                                <i class="mdi mdi-format-list-bulleted text-success"></i>
    ...
    <div class="row mb-3">
        <div class="col-lg-6">
            <h5 class="d-inline-block me-2">🏆 Acme's Team </h5>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="task-box">
                        ...
                        <h5 class="mt-0 mb-1">Quality Analysis Team </h5>
                        <p class="text-muted mb-1">In the pursuit of excellence, there is no room for mediocrity. Strive
            ...
            <div class="card">
                <div class="card-body">
                    <div class="task-box">
                        ...
                        <h5 class="mt-0 mb-1">Purchase Team</h5>
                        <p class="text-muted mb-1">The purchase team's expertise lies in finding opportunities,
                            negotiating smartly, and optimizing resources for organizational success.
                        </p>
                        <p class="text-muted text-end mb-1">50% Complete</p>
                        <div class="progress mb-4" style="height: 4px;">
                            <div class="progress-bar bg-pink" role="progressbar" style="width: 50%;" aria-valuenow="50"
            ...
            <div class="card">
                <div class="card-body">
                    <div class="task-box">
                        ...
                        <h5 class="mt-0 mb-1">Billing Team</h5>
                        <p class="text-muted mb-1">The billing team's expertise and commitment drive financial success,
            ...
            <div class="card">
                <div class="card-body">
                    <div class="task-box">
                        ...
                        <h5 class="mt-0 mb-1">Production Team</h5>
                        <p class="text-muted mb-1">A well-coordinated production team is the heartbeat of operational
                            excellence.
                        </p>
                        <p class="text-muted text-end mb-1">95% Complete</p>
                        <div class="progress mb-4" style="height: 4px;">
                            <div class="progress-bar bg-purple" role="progressbar" style="width: 95%;"
            ...
            <div class="card">
                <div class="card-body">
                    <div class="task-box">
                        ...
                        <h5 class="mt-0 mb-1">Tender Team</h5>
                        <p class="text-muted mb-1">The tender team's tenacity and determination transform challenges
                            into opportunities and aspirations into reality.
                        </p>
                        <p class="text-muted text-end mb-1">37% Complete</p>
                        <div class="progress mb-4" style="height: 4px;">
                            <div class="progress-bar bg-secondary" role="progressbar" style="width: 37%;"
            ...
            <div class="card">
                <div class="card-body">
                    <div class="task-box">
                        ...
                        <h5 class="mt-0 mb-1">Technical Team
                        </h5>
                        <p class="text-muted mb-1">The technical team's dedication to excellence ensures that we stay at
...
<script src="assets/pages/projects-task.init.js"></script>